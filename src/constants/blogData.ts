...
import { blogNineteenData } from './blogs/blogNineteen-data';
import { blogTwentyData } from './blogs/blogTwenty-data';
import { blogTwentyOneData } from './blogs/blogTwentyOne-data';
