    ...
    <div className="px-6 py-8 space-y-6" style={{ backgroundColor: '#fcfdf6' }}>
      ...
      <div>
        ...
        <p className="mt-2 max-w-3xl mb-4 sm:mb-6" style={{ color: '#6c5f31' }}>
          Review and edit your marketing activities. Changes are automatically saved. We
          use <strong style={{ color: '#080c04' }}>verified emission factors</strong> for
      ...
      >
        {activities.map((activity, index) => {
          ...
          const totalQuantity = activity.quantities
            ? Object.values(activity.quantities).reduce(
                (sum, data: any) => sum + data.value,
                0
              )
            : 0
          ...
          const pieChartData =
            activity.quantities && totalQuantity > 0
              ? Object.entries(activity.quantities).map(([key, data]: [string, any]) => {
                  ...
                  const proportionalEmission =
                    (data.value / totalQuantity) * totalActivityEmission
          ...
          return (
            ...
            >
              ...
              <AccordionContent
                ...
                style={{ backgroundColor: '#fcfdf620' }}
              >
                {/* Grid */}
                  ...
                  <div className="flex flex-col h-full items-center justify-start">
                    ...
                    {calculatingEmissions[activity.id] ? (
                      ...
                      <div className="flex flex-col items-center justify-start space-y-6 py-10">
                        ...
                        >
                          <div className="text-sm mb-1" style={{ color: '#6c5f31' }}>
                            Equivalent to
                          </div>
                          <div
                          ...
                          <div className="text-sm" style={{ color: '#6c5f31' }}>
                            tCO₂e
                          </div>
                        </div>
                      </div>
