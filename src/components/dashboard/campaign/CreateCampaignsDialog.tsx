        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-4 py-4">
                      ...
                      <SelectItem key={campaign.id} value={campaign.id}>
                        <div className="flex items-center justify-between gap-2 w-full">
                          ...
                          <Badge 
                            ...
                            className={campaign.status === 'ENABLED' ? 'bg-tertiary/20 text-tertiary border-tertiary/30' : ''}
                          >
                            {campaign.status}
                          </Badge>
                        </div>
            ...
            {autoGeneratedUTMs.length > 0 && (
              <Card className="border-[#ff8904]/30 bg-[#ff8904]/5">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-sm flex items-center gap-2">
                        <Sparkles className="h-4 w-4 text-[#ff8904]" />
                    ...
                    <Badge variant="secondary" className="text-xs bg-[#ff8904]/20 text-[#ff8904] border-[#ff8904]/30">
                ...
                <CardContent className="space-y-2">
                  {autoGeneratedUTMs.map((utm, idx) => (
                    <div
                      ...
                      className={`
                        ...
                        ${utm.selected 
                          ? 'bg-white border-[#ff8904]/30 shadow-sm' 
                    ...
                    >
                      <Checkbox
                        ...
                        disabled={isFormDisabled}
                        className="mt-1 data-[state=checked]:bg-[#ff8904] data-[state=checked]:border-[#ff8904]"
                      />
                      <div className="flex-1 min-w-0">
                        ...
                        >
                          <code className="text-xs bg-[#ff8904]/20 px-2 py-0.5 rounded font-mono text-[#ff8904]">
                            {utm.key}
                          </code>
                        ...
                        {utm.description && (
                          <p className="text-xs text-gray-600 mt-1 flex items-start gap-1">
                            <Info className="h-3 w-3 mt-0.5 flex-shrink-0 text-[#ff8904]" />
                            {utm.description}
                          </p>
                        )}
                      </div>
                  ...
                  {selectedCount > 0 && (
                    <div className="space-y-2 pt-3 border-t border-[#ff8904]/20">
                      <Label className="text-xs flex items-center gap-1 text-gray-700">
                        <Link2 className="h-3 w-3 text-[#ff8904]" />
