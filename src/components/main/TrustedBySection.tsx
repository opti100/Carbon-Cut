...
<div className='px-4 sm:px-6 lg:px-8'>
      ...
      <div className="relative flex h-[400px] md:h-[600px] lg:h-[850px] w-full items-center justify-center overflow-hidden bg-[#fcfdf6]">
        ...
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#fcfdf6] to-transparent z-20 pointer-events-none" />

        {/* Semi-circle 1 - 350px radius */}
        <svg
          className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none w-[280px] h-[140px] md:w-[500px] md:h-[250px] lg:w-[700px] lg:h-[350px] z-0"
          viewBox="0 0 700 350"
        >
          <path
        ...
        <div className="icon-orbit-1">
          <Image
            src="/companies/ChatWise.png"
            alt="Coming soon"
            width={50}
            height={50}
            className="w-[30px] h-[30px] md:w-10 md:h-10 lg:w-[50px] lg:h-[50px] rounded-4xl"
          />
        </div>
        ...
        <svg
          className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none w-[400px] h-[200px] md:w-[700px] md:h-[350px] lg:w-[1000px] lg:h-[500px]"
        ...
        <div className="icon-orbit-2" style={{ animationDelay: '-5s' }}>
          <Image
            src="/CarbonCut-fe/companies/GGS.avif"
            alt="Coming Soon"
            width={50}
            height={50}
            className="w-[30px] h-[30px] md:w-10 md:h-10 lg:w-[50px] lg:h-[50px] rounded-4xl"
        ...
        <svg
          className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none w-[520px] h-[260px] md:w-[910px] md:h-[455px] lg:w-[1300px] lg:h-[650px]"
        ...
        <svg
          className="absolute bottom-0 left-1/2 -translate-x-1/2 pointer-events-none w-[640px] h-80 md:w-[1120px] md:h-[560px] lg:w-[1600px] lg:h-[800px]"
        ...
        <style jsx>{`
          ...
          @keyframes orbit-semi-1 {
            ...
            100% {
              transform: translate(-50%, 0) rotate(360deg) translateY(-140px)
                rotate(-360deg);
            }
          }
          ...
          @keyframes orbit-semi-2 {
            ...
            100% {
              transform: translate(-50%, 0) rotate(360deg) translateY(-200px)
                rotate(-360deg);
            }
          }
          ...
          @keyframes orbit-semi-3 {
            ...
            100% {
              transform: translate(-50%, 0) rotate(360deg) translateY(-260px)
                rotate(-360deg);
            }
          }
          ...
          @keyframes orbit-semi-4 {
            ...
            100% {
              transform: translate(-50%, 0) rotate(360deg) translateY(-320px)
                rotate(-360deg);
            }
          }
          ...
          @media (min-width: 768px) {
            @keyframes orbit-semi-1 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-250px)
                  rotate(-360deg);
              }
            }
            ...
            @keyframes orbit-semi-2 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-350px)
                  rotate(-360deg);
              }
            }
            ...
            @keyframes orbit-semi-3 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-455px)
                  rotate(-360deg);
              }
            }
            ...
            @keyframes orbit-semi-4 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-560px)
                  rotate(-360deg);
              }
            }
          }
          ...
          @media (min-width: 1024px) {
            ...
            @keyframes orbit-semi-2 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-500px)
                  rotate(-360deg);
              }
            }
            ...
            @keyframes orbit-semi-3 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-650px)
                  rotate(-360deg);
              }
            }
            ...
            @keyframes orbit-semi-4 {
              ...
              100% {
                transform: translate(-50%, 0) rotate(360deg) translateY(-800px)
                  rotate(-360deg);
              }
            }
          }
