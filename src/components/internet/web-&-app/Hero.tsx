    ...
    <div className="relative mx-auto my-10 flex max-w-8xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-6xl text-center text-2xl font-mono font-bold text-[#6c5f31] md:text-4xl lg:text-7xl ">
          {'Track Your Digital Product'.split(' ').map((word, index) => (
            <motion.span
              key={index}
...
const projects = [
  {
    ...
    description: 'Copy and paste the script tag into your code to get started',
  },
  {
    title: 'Test the integration in development first',
    description: 'Verify the SDK is working correctly before deploying to production',
  },
  {
