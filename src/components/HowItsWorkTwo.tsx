...
export default function EmissionsTracker() {
 ...
 {/* Track, Cut, and Offset Emissions */}
            ...
            {/* Steps */}
            <div className="max-w-6xl mx-auto px-4 pb-16 text-black">
                {/* Step 1 - Calculate */}
                <div className="flex flex-col lg:flex-row items-center mb-16">
                    <div className="lg:w-1/5 mb-8 lg:mb-0 lg:pr-8">
                    ...
                    <div className="lg:w-4/5">
                        <div className="relative bg-gradient-to-r from-red-900 to-purple-900 rounded-full p-8 h-64 flex items-center justify-center overflow-hidden">
                            <Image
                ...
                {/* Step 2 - Analyze */}
                <div className="flex flex-col lg:flex-row-reverse items-center mb-16 text-black">
                    <div className="lg:w-1/5 mb-8 lg:mb-0 lg:pl-8">
                    ...
                    <div className="lg:w-4/5">
                        <div className="relative bg-gradient-to-r from-green-600 to-emerald-500 rounded-full p-8 h-64 flex items-center justify-center overflow-hidden">
                            <Image
                                src="/green-moss.jpg"
                                alt="Description"
                                fill
                ...
                <div className="flex flex-col lg:flex-row items-center mb-16">
                    ...
                    <div className="lg:w-4/5">
                        <div className="relative bg-gradient-to-r from-gray-400 to-gray-300 rounded-full p-8 h-64 flex items-center justify-center overflow-hidden">
                            <Image
