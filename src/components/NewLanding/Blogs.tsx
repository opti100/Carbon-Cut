...
const blogs = [
  ...
  {
    image: blogSevenData.image || '/blogs/blogSeven.png',
    date: new Date(blogSevenData.date).toLocaleDateString('en-US', { 
      month: 'short', 
      day: 'numeric', 
      year: 'numeric' 
    }),
    
    readTime: blogSevenData.readTime,
    title: blogSevenData.title,
    slug: blogSevenData.slug,
  },
];
          ...
          <div className='flex flex-col md:flex-row  w-full'>
            {blogs.map((blog, index) => (
              <Link 
                ...
                key={index}
                className="flex flex-col gap-4 transition-all duration-700 ease-out cursor-pointer group block"
                style={{
              ...
              >
                ...
                <div className='flex flex-col gap-2 px-2 sm:px-4'>
                  ...
                  <h3 className={`font-medium text-[#080c04] leading-tight transition-all duration-700 ${
                    hoveredIndex === index 
