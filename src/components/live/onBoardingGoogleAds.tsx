...
export default function OnboardingGoogleAds({ onNext }: OnboardingGoogleAdsProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-6 max-w-6xl ">
      {/* Header */}
      ...
      {!isConnected ? (
        <div className="space-y-4 w-full">
          ...
          <Button
            ...
            disabled={isLoading}
            className="bg-white text-gray-900 hover:bg-gray-100 border font-medium px-2 text-sm rounded-lg h-12 w-full"
            size="lg"
          >
            {isLoading ? (
              <>
