...
const BlogDashboard = () => {
  ...
  return (
    <div className="min-h-screen mt-16" style={{ backgroundColor: colors.background }}>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mt-4">
            Explore the latest trends, metrics, and technologies to accurately calculate
            and minimize your marketing emissions.
          </p>
        </div>
