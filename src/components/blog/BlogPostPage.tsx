...
const blogContentComponents: Record<string, React.ComponentType> = {
  'how-marketing-is-killing-the-world-one-ad-at-a-time-and-what-to-do-about-it':
    BlogOneContent,
  ...
  'are-sustainability-experts-still-experts-if-they-cant-measure-internet-emissions':
    blogFiveContent,
  'ai-hidden-emissions-why-the-next-era-of-innovation-needs-carbon-intelligence':
    BlogSixContent,
  'carbon-footprint-calculator-2-0': BlogSevenContent,
  'how-carbon-tech-international-limited-is-redefining-real-time-carbon-intelligence-through-carboncut':
    BlogEightContent,
