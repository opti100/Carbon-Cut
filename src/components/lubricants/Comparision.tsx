  ...
  return (
    <div className="min-h-screen bg-[#fcfdf6] text-[#080c04] font-mono p-8">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-b border-[#d1cebb]  text-[#d1cebb] mx-auto mb-20 text-end">
          <div className="text-xs ">01 // Advancement</div>
          <div className="text-5xl md:text-6xl font-bold mb-4">{comparisonData.title}</div>
        </div>
              ...
              <React.Fragment key={idx}>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-sm text-[#b0ea1d]">{feature.carboncut}</div>
                  </div>
                </div>
              </React.Fragment>
            ))}
        ...
        <div className="mt-12 grid grid-cols-2 gap-8">
          <div className="border border-[#d1cebb] p-8 bg-[#fcfdf6]">
            ...
            <pre className="text-sm text-[#6c5f31]">
              <code>
                <span className="text-[#6c5f31]">class</span> <span className="text-[#080c04]">LegacySystem</span> {"{\n"}
                {"  "}reporting: <span className="text-[#F0db18]">'annual'</span>,{"\n"}
                {"  "}accuracy: <span className="text-[#F0db18]">'averaged'</span>,{"\n"}
                {"  "}cost: <span className="text-[#F0db18]">'high'</span>,{"\n"}
                {"  "}integrations: <span className="text-[#6c5f31]">null</span>{"\n"}
                {"}"}
              </code>
            </pre>
          </div>
          ...
          <div className="border border-[#d1cebb] p-8 bg-[#fcfdf6]">
            ...
            <pre className="text-sm">
              <code>
                ...
                {"  "}reporting: <span className="text-[#F0db18]">'real-time'</span>,{"\n"}
                {"  "}accuracy: <span className="text-[#F0db18]">'precision'</span>,{"\n"}
                {"  "}cost: <span className="text-[#F0db18]">'fractional'</span>,{"\n"}
                {"  "}integrations: [<span className="text-[#F0db18]">'ERP'</span>, <span className="text-[#F0db18]">'API'</span>]{"\n"}
                {"}"};</code>
            </pre>
          </div>
        </div>
        ...
        <div className="mt-12 border border-[#d1cebb] p-8 bg-[#fcfdf6]">
          ...
          <div className="grid grid-cols-4 gap-8">
            ...
            <div>
              <div className="text-3xl text-[#b0ea1d] mb-2">99.9%</div>
