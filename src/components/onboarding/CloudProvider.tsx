    ...
    <div className="w-full space-y-8">
      <div className="space-y-4">
        ...
        <div className="rounded-lg  overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              <h3 className="font-semibold text-base text-neutral-900">Option 1: Enter details manually</h3>
            </div>
            <ChevronDown
              size={20}
        ...
        <div className="rounded-lg  overflow-hidden">
          ...
          >
            <div className="flex items-center gap-3">
              <h3 className="font-semibold text-base text-neutral-900">Option 2: Upload File</h3>
            </div>
            <ChevronDown
              size={20}
              className={`transition-transform text-neutral-400 ${
