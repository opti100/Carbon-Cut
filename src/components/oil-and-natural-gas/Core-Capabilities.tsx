...
const content = [
  {
    description:
      " Drilling, production, and methane monitoring",
    title: (
      <AnimatedHeading
        text="Upstream Emissions"
  ...
  {
    description:
      "Compressor stations, pipelines, and processing plants",
    title: (
      <AnimatedHeading
        text="Midstream Tracking"
        className="text-3xl font-semibold"
      />
    ),
  },
  {
    description:
      "Refineries, terminals, distribution networks",
    title: (
      <AnimatedHeading
        text="Downstream Footprint "
        className="text-3xl font-semibold"
      />
    ),
  },
